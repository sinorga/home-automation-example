...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Signup = __webpack_require__(261);

	var _Signup2 = _interopRequireDefault(_Signup);

	var _Account = __webpack_require__(262);

	var _Account2 = _interopRequireDefault(_Account);

	var _Lightbulbs = __webpack_require__(263);

	var _Lightbulbs2 = _interopRequireDefault(_Lightbulbs);

	var _Lightbulb = __webpack_require__(266);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: '/lightbulbs', component: _Lightbulbs2.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: '/lightbulbs/:sn', component: _Lightbulb2.default })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  displayName: 'App',
	  render: function render() {
	    var logout_if_logged_in = true //this.context.store.getState().auth.session !== undefined
	    ? _react2.default.createElement(
	      'div',
	      { id: 'app-nav' },
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _reactRouter.Link,
	              { to: '/' },
	              _react2.default.createElement('img', { className: 'logo', src: 'example-app-logo.svg' })
	            )
	          ),
	          logout_if_logged_in
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lightbulbs = __webpack_require__(244);
	...
	var app = (0, _redux.combineReducers)({
	  auth: _auth2.default,
	  lightbulbs: _lightbulbs2.default
	});
...
/***/ function(module, exports) {
	...
	function getInitialState() {
	  var session = void 0;
	  var session_text = window.sessionStorage.getItem('session');
	...
	function reducer(state, action) {
	  ...
	  switch (action.type) {
	    ...
	    case 'DELETE_LIGHTBULB_SUCCESS':
	      return _extends({}, state, {
	        isDeleting: false,
	        statuses: [].concat(_toConsumableArray(state.statuses.filter(function (x) {
	          return x.serialnumber !== action.serialnumber;
	        })))
	      });
	    ...
	    case 'SHARE_SUCCESS':
	      return _extends({}, state, {
	        isSharing: false,
	        shares: [].concat(_toConsumableArray(state.shares), [{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var babelHelpers = __webpack_require__(246);
	/**
	        ...
	        _react2.default.createElement(
	          _button2.default,
	          {
	            ...
	            onClick: function onClick() {
	              _reactRouter.browserHistory.push('/lightbulbs');
	            } },
	          'My Lightbulbs'
	        ),
	        _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jqLite = __webpack_require__(250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  handleLogin: function handleLogin(event) {
	    ...
	    (0, _auth.attemptLogin)(email, password)(this.context.store.dispatch);
	  },
	  componentDidMount: function componentDidMount() {
	    var _this = this;
	  ...
	  render: function render() {
	    var spinner_when_waiting = this.context.store.getState().auth.status === 'waiting' ? _react2.default.createElement(_spinner2.default, null) : _react2.default.createElement(_spinner2.default, { style: { visibility: "hidden" } });

	    var error_message = this.context.store.getState().auth.error == null ? _react2.default.createElement('div', null) : _react2.default.createElement(
	      'div',
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(_input2.default, { label: 'Email', floatingLabel: true }),
	        _react2.default.createElement(_input2.default, { type: 'password', label: 'Password', floatingLabel: true }),
	        _react2.default.createElement(
	          _button2.default,
	          { color: 'secondary' },
	          'Login'
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      "div",
	      _extends({ className: "small progress" }, this.props),
	      _react2.default.createElement(
	        "div",
	        null,
	        "Loading…"
...
/***/ function(module, exports) {
	...
	exports.reportSignupSuccess = reportSignupSuccess;
	exports.reportSignupError = reportSignupError;
	exports.attemptPasswordChange = attemptPasswordChange;
	exports.reportPasswordChangeSuccess = reportPasswordChangeSuccess;
	exports.reportPasswordChangeError = reportPasswordChangeError;
	exports.attemptLogin = attemptLogin;
	exports.reportLoginSuccess = reportLoginSuccess;
	exports.reportLoginError = reportLoginError;
	...
	function reportSignupSuccess(session) {
	  return function (dispatch) {
	    dispatch({
	      type: 'SIGNUP_SUCCESS',
	      session: session
	...
	function reportSignupError(error) {
	  return function (dispatch) {
	    dispatch({
	      type: 'SIGNUP_ERROR',
	      error: error
	...
	function attemptPasswordChange(password) {
	  return function (dispatch) {
	    dispatch({
	...
	function reportPasswordChangeSuccess() {
	  return function (dispatch) {
	    dispatch({
	...
	function reportPasswordChangeError(error) {
	  return function (dispatch) {
	    dispatch({
	...
	function reportLoginSuccess(session) {
	  return function (dispatch) {
	    dispatch({
	      type: 'LOGIN_SUCCESS',
	      session: session
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  handleLogout: function handleLogout(event) {
	    ...
	    (0, _auth.logout)()(this.context.store.dispatch);
	  },
	  componentWillMount: function componentWillMount() {
	    var _this = this;
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        _button2.default,
	        { color: 'secondary', onClick: this.handleLogout },
	        'Logout'
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  handleForm: function handleForm(event) {
	    ...
	    (0, _auth.attemptSignup)(email, password)(this.context.store.dispatch);
	  },
	  componentWillMount: function componentWillMount() {
	    var _this = this;
	  ...
	  render: function render() {
	    ...
	    var error_message = this.context.store.getState().auth.status !== "error" ? _react2.default.createElement('div', null) : _react2.default.createElement(
	      'div',
	      { className: 'messagebox error' },
	      this.context.store.getState().auth.error
	    );
	    ...
	    var success_message = this.context.store.getState().auth.status !== "good" ? _react2.default.createElement('div', null) : _react2.default.createElement(
	      'div',
	    ...
	    var signup_form = _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(_input2.default, { label: 'Email Address', floatingLabel: true }),
	        _react2.default.createElement(_input2.default, { label: 'Password', type: 'password', floatingLabel: true }),
	        _react2.default.createElement(
	          _button2.default,
	          { color: 'secondary' },
	          'Signup'
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  handleForm: function handleForm(event) {
	    ...
	    var color = event.target.elements[1].value;
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        _form2.default,
	        { onSubmit: this.handleForm },
	        _react2.default.createElement(_input2.default, { label: 'Name', floatingLabel: true }),
	        _react2.default.createElement(_input2.default, { label: 'Favorite Color', floatingLabel: true }),
	        _react2.default.createElement(
	          _button2.default,
	          { color: 'primary' },
	          'Update'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _add_lightbulb_form = __webpack_require__(264);

	var _add_lightbulb_form2 = _interopRequireDefault(_add_lightbulb_form);

	var _lightbulbs = __webpack_require__(265);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = _react2.default.createClass({
	  displayName: 'Lightbulbs',

	  contextTypes: {
	    store: _react2.default.PropTypes.object
	  },

	  handleAddLightbulb: function handleAddLightbulb(request) {
	    (0, _lightbulbs.attemptAddLightbulb)(request.sn)(this.context.store.dispatch, this.context.store.getState);
	  },
	  componentWillMount: function componentWillMount() {
	    var _this = this;
	    ...
	    (0, _lightbulbs.requestLightbulbs)()(this.context.store.dispatch, this.context.store.getState);
	  ...
	  updateStatuses: function updateStatuses() {
	    var _this2 = this;
	  ...
	  componentWillUnmount: function componentWillUnmount() {
	    ...
	    if (this.pollTimer != undefined) {
	      window.clearTimeout(this.pollTimer);this.pollTimer = undefined;
	    }
	  ...
	  render: function render() {
	    ...
	    var spinner_when_waiting = this.context.store.getState().lightbulbs.isFetching && this.context.store.getState().lightbulbs.statuses.length == 0 ? _react2.default.createElement(_spinner2.default, null) : _react2.default.createElement(_spinner2.default, { style: { visibility: "hidden" } });
	    ...
	    var info_message_when_none = this.context.store.getState().lightbulbs.statuses.length === 0 ? _react2.default.createElement(
	      'div',
	      { className: 'messagebox info' },
	      'You do not have any lightbulbs, you can add one below.'
	    ) : _react2.default.createElement('div', null);
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'ul',
	        { className: 'detaillist list' },
	        state.lightbulbs.statuses.sort(function (a, b) {
	          return a.serialnumber > b.serialnumber;
	        }).map(function (m, i) {
	          var state_text = m.isUpdating ? _react2.default.createElement(
	            'span',
	            null,
	            '...'
	          ) : _react2.default.createElement(
	            ...
	            {
	              onClick: function onClick() {
	                (0, _lightbulbs.attemptToggleLightbulbState)(m.serialnumber)(_this3.context.store.dispatch, _this3.context.store.getState);
	              },
	          ...
	          return _react2.default.createElement(
	            'li',
	            { className: 'detaillist row', key: m.serialnumber },
	            _react2.default.createElement(
	              'ul',
	              { className: 'detaillist itemlist' },
	              _react2.default.createElement(
	                'li',
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'a',
	                  { onClick: function onClick() {
	                      _reactRouter.browserHistory.push('/lightbulbs/' + m.serialnumber);
	                    } },
	                  '☰'
	                )
	              )
	      ...
	      _react2.default.createElement(_add_lightbulb_form2.default, { onSubmit: this.handleAddLightbulb, isLoading: state.lightbulbs.isAdding })
	    );
	  }
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  displayName: 'add_lightbulb_form',
	  handleForm: function handleForm(event) {
	    event.preventDefault();
	    var sn = event.target.elements[0].value;
	  ...
	  render: function render() {
	    var spinner_when_waiting = this.props.isLoading ? _react2.default.createElement(_spinner2.default, null) : _react2.default.createElement('div', null);
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        _form2.default,
	        { onSubmit: this.handleForm },
	        _react2.default.createElement(_input2.default, { label: 'Serial Number', floatingLabel: true }),
	        _react2.default.createElement(
	          _button2.default,
	          { color: 'primary' },
	          'Add'
...
/***/ function(module, exports) {
	...
	exports.requestShares = requestShares;
	exports.resultShares = resultShares;
	exports.attemptShare = attemptShare;
	exports.attemptToggleLightbulbState = attemptToggleLightbulbState;
	exports.requestLightbulbs = requestLightbulbs;
	exports.attemptAddLightbulb = attemptAddLightbulb;
	exports.attemptDeleteLightbulb = attemptDeleteLightbulb;
	function requestStates(auth) {
	  return function (dispatch) {
	    dispatch({
	...
	function attemptShare(email, serialnumber) {
	  return function (dispatch) {
	    dispatch({
	      type: 'ATTEMPT_SHARE',
	      email: email,
	...
	function attemptToggleLightbulbState(serialnumber) {
	  return function (dispatch, getState) {
	    ...
	    var lightbulbs = _getState.lightbulbs;
	    var _auth$session = auth.session;
	    var token = _auth$session.token;
	    var email = _auth$session.email;

	    // HACK

	    email = email || window.sessionStorage.getItem('email');

	    var current_state = lightbulbs.statuses.filter(function (v) {
	      return v.serialnumber == serialnumber;
	    })[0].state;
	    var new_state = current_state == "off" ? "on" : "off";
	...
	function requestLightbulbs() {
	  return function (dispatch, getState) {
	    ...
	    var _auth$session2 = auth.session;
	    var token = _auth$session2.token;
	    var email = _auth$session2.email;
	...
	function attemptAddLightbulb(serialnumber) {
	  return function (dispatch, getState) {
	    dispatch({
	    ...
	    var lightbulbs = _getState3.lightbulbs;
	    var _auth$session3 = auth.session;
	    var token = _auth$session3.token;
	    var email = _auth$session3.email;
	...
	}function attemptDeleteLightbulb(serialnumber) {
	  return function (dispatch, getState) {
	    dispatch({
	    ...
	    var lightbulbs = _getState4.lightbulbs;
	    var _auth$session4 = auth.session;
	    var token = _auth$session4.token;
	    var email = _auth$session4.email;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _share_lightbulb_form = __webpack_require__(267);

	var _share_lightbulb_form2 = _interopRequireDefault(_share_lightbulb_form);
	...
	exports.default = _react2.default.createClass((_React$createClass = {
	  ...
	  var state = this.context.store.getState();
	  this.unsubscribe = this.context.store.subscribe(function () {
	    if (state.lightbulbs.statuses.filter(function (v) {
	      return v.serialnumber == _this.props.params.sn;
	    }).length == 0) {
	      _reactRouter.browserHistory.push('/lightbulbs');
	    }
	    // FIXME: This is definitely the wrong way to do this, use react-redux's `connect`
	...
	}), _defineProperty(_React$createClass, 'handleShare', function handleShare(r) {
	  (0, _lightbulbs.attemptShare)(r.email, this.props.params.sn)(this.context.store.dispatch);
	}), _defineProperty(_React$createClass, 'handleDelete', function handleDelete(r) {
	  (0, _lightbulbs.attemptDeleteLightbulb)(this.props.params.sn)(this.context.store.dispatch, this.context.store.getState);
	}), _defineProperty(_React$createClass, 'render', function render() {
	  var _this2 = this;

	  var spinner_when_waiting = this.context.store.getState().lightbulbs.isFetching ? _react2.default.createElement(_spinner2.default, null) : _react2.default.createElement(_spinner2.default, { style: { visibility: "hidden" } });
	  ...
	  return _react2.default.createElement(
	    ...
	    state.lightbulbs.shares.filter(function (v) {
	      return v.id == _this2.props.params.sn;
	    ...
	    _react2.default.createElement(_share_lightbulb_form2.default, { onSubmit: this.handleShare }),
	    _react2.default.createElement(
	      'h3',
	      null,
	      'Delete'
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  displayName: 'share_lightbulb_form',
	  handleForm: function handleForm(event) {
	    event.preventDefault();
	    var email = event.target.elements[0].value;
