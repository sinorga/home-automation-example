...
export default React.createClass({
  ...
  render () {
    ...
    return (
      <div>
        <AppBar style={ appBarStyle } showMenuIconButton={false} iconElementRight={ <RaisedButton linkButton={true} onClick={() => { hashHistory.push('/signup') }} label="SIGNUP" primary={true} /> } />
